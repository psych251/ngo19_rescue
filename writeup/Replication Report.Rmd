...
Experimental Paradigm: http://173.236.204.40/st/ngo19rep/index.html?PROLIFIC_PID=progress3_demo&STUDY_ID=1&SESSION_ID=progress3
...
Original effect size was d = 1.32. Replication effect size was d = 0.15.

From G\*Power Analysis for samples to achieve: 80%: N = 6 90%: N = 7 95% power: N = 8

Considerations of feasibility for selecting planned sample size. - sample size should be bigger than N = 8. Replication had N = 11 participants but only got effect size of d = 0.15. When I put this effect size into G\*Power, I need a sample size of N = 277 to get 80% power. However, this is not feasible, budget-wise, so I will be using the Small Telescopes method (Simonsohn, 2014) and doing 2.5 times the original sample size. 
...
```{r}
round(effectsize::cohens_d(key_test)$Cohens_d, 2)
